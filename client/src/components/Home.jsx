...
export default function Home() {
	return (
		<div>
			<h1 className="text-black sm:flex sm:justify-center sm:text-6xl sm:font-bold  sm:pt-10 underline">
				{' '}
			...
			<div className=" ">
				...
				<div className="pr-8">
					<div className="flex flex-col pt-10 pl-2 sm:grid sm:grid-span-2 sm:pt-10 sm:pl-32 sm:pr-32  ">
						<h1 className="font-bold font-mono sm:text-xl text-blue-800">
							Insumos
						</h1>
						<HomeTableInsumos />
					</div>
